...
const P = (o) => ({ status: { label: "Complete", tone: "ok" }, tags: [], images: [], videos: [], attachments: [], body: [], ...o });

window.PROJECTS = [
  P({
    id: "P-017", title: "Introduction to Programming — C++ Portfolio", discipline: "Software",
    year: "2026", date: "June 7, 2026", grade: "HD",
  ...
  P({
    id: "P-016", title: "Photometric Distance and Age of the Open Cluster NGC 2175", discipline: "Astrophysics",
    year: "2026", date: "May 31, 2026",
  ...
  P({
    id: "P-015", title: "Viscous Flow Regimes in a Large-Eddy Simulation", discipline: "Aerospace",
    year: "2026", date: "May 31, 2026",
  ...
  P({
    id: "P-014", title: "Boundary Layers in Laminar and Turbulent Flow Regimes using CFD", discipline: "Aerospace",
    year: "2026", date: "April 19, 2026", featured: true, grade: "HD",
  ...
  P({
    id: "P-013", title: "Galaxy Collision Simulation", discipline: "Astrophysics",
    year: "2025", date: "October 30, 2025", featured: true, grade: "HD",
    ...
    images: [
      { file: "m51-and-companion_0-jpg.jpg", caption: "The Whirlpool Galaxy, M51, a spiral galaxy 31 million light-years away — Hubble (NASA, ESA)" },
      { file: "orbit_energy.png", caption: "Left: total energy over time, the dotted line showing conservation. Right: total angular momentum magnitude." },
      { file: "image.png", caption: "Snapshot of the parameters able to be tweaked by the user." },
    ],
    videos: [
      { caption: "Full 3D numerical integration — two massive bodies and 240 massless stars", source: "orbit_3d.mp4" },
  ...
  P({
    id: "P-012", title: "Aerodynamic Glider Analysis", discipline: "Aerospace",
    year: "2025", date: "October 27, 2025",
  ...
  P({
    id: "P-011", title: "Tumbling Rocket — Intermediate Axis Theorem", discipline: "Aerospace",
    year: "2025", date: "October 24, 2025", featured: true, grade: "HD",
    ...
    images: [
      ...
      { file: "fig4.png", caption: "Euler angles of the rocket over time — each is the angle from its respective principal axis." },
      { file: "fig3.png", caption: "A closer look at the target object." },
    ],
    videos: [
      { caption: "Rocket undergoing torque-free motion in three dimensions — chaotic, unstable rotation", source: "spacecraft_animation_20fps_100s.mp4" },
  ...
  P({
    id: "P-010", title: "Rocket Launch Simulation", discipline: "Aerospace",
    year: "2025", date: "October 10, 2025",
    ...
    images: [
      ...
      { file: "altitude_vs_time.png", caption: "Altitude in kilometres over time — the 'edge of the atmosphere' sits at about 100 km." },
      { file: "drag_vs_time.png", caption: "Drag over time. Air density falls off steadily above a certain altitude; data is cut off moments before impact due to the ballistic nature of re-entry." },
  ...
  P({
    id: "P-009", title: "Warman Project", discipline: "Engineering",
    year: "2025", date: "May 29, 2025", featured: true,
  ...
  P({
    id: "P-008", title: "CSWA Certificate", discipline: "Engineering",
    year: "2025", date: "May 21, 2025",
  ...
  P({
    id: "P-007", title: "Shock Theory in a Supersonic Wind Tunnel", discipline: "Aerospace",
    year: "2024", date: "October 19, 2024",
  ...
  P({
    id: "P-006", title: "Stellar Compact Objects", discipline: "Astrophysics",
    year: "2024", date: "October 9, 2024",
  ...
  P({
    id: "P-005", title: "Stirling Engine Thermodynamic Properties", discipline: "Engineering",
    year: "2024", date: "September 27, 2024",
  ...
  P({
    id: "P-004", title: "Internal Combustion Engine Thermodynamic Properties", discipline: "Engineering",
    year: "2024", date: "September 27, 2024",
  ...
  P({
    id: "P-003", title: "Properties of Microwaves", discipline: "Physics",
    year: "2024", date: "August 31, 2024",
  ...
  P({
    id: "P-002", title: "Detecting Extrasolar Planets using the Transit Method", discipline: "Astrophysics",
    year: "2024", date: "May 19, 2024",
  ...
  P({
    id: "P-001", title: "Star Characteristics in NGC 2301", discipline: "Astrophysics",
    year: "2024", date: "March 22, 2024",
